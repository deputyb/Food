...
(function (wegmans) {
    ...
    wegmans.views.eyebrowNavigation = Backbone.Collection.extend({

        /**
         * Initialize
         */
        initialize: function initialize() {
            console.log('eyebrow navigation collection => initialized');
        }
    });
})(wegmans);
'use strict';
...
var DataLoaded = (function () {
    ...
    function DataLoaded(packageSpace) {
    ...
    _createClass(DataLoaded, [{
        key: 'instantiateBackboneCollectionModels',
        value: function instantiateBackboneCollectionModels() {
            var _this = this;
            ...
            _.forEach(this.apiConfigurations, function (apiConfiguration) {

                // Checking if the object with name collectionName exists in our wegmans global object
                if (!_this.package.collections[apiConfiguration.collectionName]) {
                ...
                currentBackboneCollection = new _this.package.collections[apiConfiguration.collectionName]();
        ...
        key: 'getApiConfigurations',
        value: function getApiConfigurations() {
        ...
        key: 'setApiConfigurations',
        value: function setApiConfigurations(DOMElement) {
